              ...
              <center>
                <h2 class="stroke">Social Service Counter UACM<br>REGISTRO</h2>
                        <form method="post" autocomplete="on">
                            <input type="text" required="required" placeholder="Nombre(s)" name="nombre" id="n" autofocus><br>
                            <input class="input_doble" type="text" required="required" placeholder="Apellido Paterno" name="apeP" id="ap">
                            <input class="input_doble" type="text" required="required" placeholder="Apellido Materno" name="apeM" id="am"><br>
                            <input class="input_doble" type="text" required="required" placeholder="Matrícula" name="matri" id="mat"> <!--Mejorar con ER-->
                            ...
                            <input class="input_doble" type="text" placeholder="Otra" name="otraCarrera"><br>    
              ...
              <?php
                ...
                if ($_POST){
                   ...
                   if (validar_contraseña($_POST["contraseña"], $error_encontrado, $_POST["rcontraseña"])){                                      
                        ...
                        $conexion = mysqli_connect("localhost","root","hansFormal","sscuacm");
                        ...
                        if (mysqli_connect_errno()) {
                            ...
                            $sql = "INSERT INTO datos_usuario
                                    (nombre, apellidoP, apellidoM, matricula, correo, carrera, fechaNacimiento)   
                                    VALUES ('$nombre','$apellidop','$apellidom','$matricula''$correo','$carrera','$nacimiento')";   //no debe existir los atributos usuario ni contrasenia en datos_usuario
